...
alpha_2 = st.sidebar.slider("3rd 𝛂", min_value=0.0, max_value=1.0, value=0.50, step=0.10, format='%.3f')
alpha_3 = st.sidebar.slider("4th 𝛂", min_value=0.0, max_value=1.0, value=0.70, step=0.10, format='%.3f')
alpha_4 = st.sidebar.slider("2nd 𝛂", min_value=0.0, max_value=1.0, value=0.90, step=0.10, format='%.3f')
...
fig = make_subplots(
  ...
  subplot_titles=(f'{alpha_1}', f'{alpha_2}', f'{alpha_3}', f'{alpha_4}')
)
u_pred_lst = []
