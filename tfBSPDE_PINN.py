...
alpha_1 = st.sidebar.slider("𝗗𝛂", min_value=0.0, max_value=1.0, step=0.10, format='%.3f')
alpha_2 = st.sidebar.slider("3rd 𝛂", min_value=0.0, max_value=1.0, step=0.10, format='%.3f')
alpha_3 = st.sidebar.slider("4th 𝛂", min_value=0.0, max_value=1.0, step=0.10, format='%.3f')
alpha_4 = st.sidebar.slider("2nd 𝛂", min_value=0.0, max_value=1.0, step=0.10, format='%.3f')
